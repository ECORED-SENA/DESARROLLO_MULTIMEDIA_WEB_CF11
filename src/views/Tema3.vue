...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      .col-lg-7.mb-4.mb-lg-0(data-aos="fade")
        .bg--paleYellow.p-4.hg-100
          p Las metodologías ágiles son adaptables a cualquier proyecto, este procedimiento permite definir y organizar las prioridades en cada etapa de la planificación, a partir de las necesidades y objetivos; y están enfocadas en conseguir resultados desde el comienzo, también ayudan a tener una mayor interacción con el cliente. 
          p #[strong Para conocer más sobre el tema, a continuación, se explican las metodologías Scrum y Kanban:]
      .col-lg-5.col-8(data-aos="zoom-in")
        figure
          img(src="@/assets/curso/temas/t3/t3_01.jpg", alt="alt")
    ...
    .row.justify-content-center.mb-5
      .col-lg-7
        h5(data-aos="fade").mb-4 La metodología Scrum
        ol(data-aos="fade").lista-ol--cuadro
          li 
            .lista-ol--cuadro__vineta.round
              span 1
            | Utilizar un plan estratégico de diseño progresivo.
          li 
            .lista-ol--cuadro__vineta.round
              span 2
            | Organizar las distintas etapas de diseño.
          li 
            .lista-ol--cuadro__vineta.round
              span 3
            | Continuar las etapas de la metodología ágil:
        ul.fa-ul.mb-0.ps-4
          li
      ...
      .col-lg-3.d-none.d-lg-flex(data-aos="zoom-in")
        .bg--darkMint.p-3
          figure.vp-50
            img(src="@/assets/curso/temas/t3/t3_02.png", alt="alt")
      .col-lg-1

    .row.justify-content-center.mb-5
      .col-lg-9
        .bg--paleBlue.brad_02.p-5(data-aos="zoom-in")
          figure
            img(src="@/assets/curso/temas/t3/t3_03.svg", alt="alt")

    h4.mb-4 Las características Scrum
      ...
      .col-lg-6.mb-4.mb-lg-0(data-aos="fade")
        LineaTiempoD.color-acento-botones
          .row(numero="1" titulo="Transparencia")
            .col
              p En la metodología Scrum las personas que hacen parte, tienen información importante sobre lo que sucede con el proyecto. Lo que repercute positivamente en el desarrollo del proyecto.

          .row(numero="2" titulo="Transparencia")
            .col
              p El equipo de trabajo Scrum, ocasionalmente analizan el desarrollo con el fin de identificar problemas, esta tecnología no se rige como un examen, simplemente es la forma en que avanza el trabajo y que el grupo actúe organizadamente.
    ...
    h4(data-aos="fade") Beneficios del Scrum
    ...
    h4(data-aos="fade").mb-4 Terminología Scrum
      ...
      .col-lg-7.mb-4.mb-lg-0
         AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")
          ...
          .row(titulo="Backlog del producto")
            .col
              p En términos generales el <em>backlog</em>, es un listado de tareas que abarca todo el proyecto. Toda acción que realicemos debe estar en el backlog de producto por un tiempo definido por el grupo de diseño. La importancia fundamental de organizar el <em>backlog</em> de producto es del <em>Owner</em>: profesional encargado de maximizar la comunicación con el cliente y verificar las prioridades definidas             
    ...
    .row.justify-content-center.mb-5
      .col-lg-7.mb-4.mb-lg-0(data-aos="fade")
        LineaTiempoD.color-acento-botones
          .row(numero="1" titulo="<em>Stop starting, start finishing</em>")
            .col
              p Acaba primero una tarea, para comenzar otra como lema de la metodología, ayuda a preferir las labores en desarrollo en relación con las recientes. Las tareas en desarrollo deben ser cortas, ya que no podrán sobrepasar las tareas en desarrollo en cada etapa. 

          .row(numero="2" titulo="Control del flujo")
            .col
              p Este método no se utiliza solo a un proyecto, también se usa en otro tipo de proyectos y trabajos, el grupo de trabajo realiza un tráfico seguido de tareas y se debe hacer supervisión del mismo al extraer la información que suministra la tarjeta.
        ...
        .bg--paleOrange.p-4.hg-100
          ul.fa-ul.mb-0.center
            ...
            li
              i.fa-li.fas.fa-check.clr--orange
              | Una respuesta.
      .col-lg-7.g-0.order-1.order-lg-2(data-aos="zoom-in")
        .bg--paleBlue.p-4
          figure
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-8.mb-4(data-aos="fade")
        p.mb-0 #[strong Estructura de los archivos XML]
      .col-lg-8(data-aos="zoom-in")
        figure
          img(src="@/assets/curso/temas/t3/t3_10.svg", alt="alt")

    h5(data-aos="fade") Características de XML
      ...
      .col-lg-7.mb-4.mb-lg-0(data-aos="fade")
        ...
        .bg--paleOrange.p-4(data-aos="zoom-in")
          ...
          ul.fa-ul.mb-0
            li
              i.fa-li.fas.fa-check.clr--orange
              | Su proceso de aplicación es sencillo.
            li
              i.fa-li.fas.fa-check.clr--orange
              | Segmenta fácilmente el contenido y el formato de presentación.
            li
              i.fa-li.fas.fa-check.clr--orange
              | Está estructurado para todo tipo de lenguaje y alfabeto.
          
      .col-lg-5.col-8(data-aos="zoom-in")
        .bg--paleBlue.hg-100.p-5.brad_02
          figure.vp-50
    ...
    .row.justify-content-center.mb-5
      .col-lg-6.mb-4.mb-lg-0(data-aos="fade")
        LineaTiempoD.color-acento-botones
          .row(numero="1" titulo="<em>Get</em>")
            .col
              p Solicita una respuesta de un recurso específico, en la forma Get, únicamente puede recuperar información.

          .row(numero="2" titulo="<em>Head</em>")
            .col
              p La forma es igual que en Get, pero sin el cuerpo de la respuesta.
              
          .row(numero="3" titulo="<em>Post</em>")
            .col
              p Su implementación se usa para enviar una solicitud en un recurso puntual, generando cambios en el estado alterno en el servidor. 

          .row(numero="4" titulo="<em>PUT</em>")
            .col
              p Cambia las formas recientes del recurso de destino, es la acción más eficiente para cargar archivos a un servidor.

          .row(numero="5" titulo="<em>Delete</em>")
            .col
              p Elimina el recurso especificado. 

          .row(numero="6" titulo="<em>Options</em>")
            .col
              p Se aplica para detallar los tipos de comunicación para el recurso de destino.

          .row(numero="7" titulo="<em>Patch</em>")
            .col
              p Es implementado para realizar actualizaciones parciales en un recurso, pero la diferencia es que se puede definir parcialmente una o varios elementos.
      ...
      .col-lg-7.g-0(data-aos="fade")        
        .bg--paleOrange.p-4.hg-100
          ...
          ul.fa-ul.mb-0
            li
              i.fa-li.fas.fa-check.clr--orange
              | Se basa en cinco operaciones comunes: listado, crear, leer, actualizar y borrar.
            li
              i.fa-li.fas.fa-check.clr--orange
              | Cada concepto requiere de dos elementos: el método URI y HTTP.
            li
              i.fa-li.fas.fa-check.clr--orange
    ...
    .row.justify-content-center.mb-5(data-aos="fade")
      .col-lg-10
        .tarjeta.tarjeta--azul.py-4.px-5
          SlyderA(tipo="b")
            .row
              .col-12         
                h5 #[em GET]       
            ...
            .row
              .col-12         
                h5 #[em PUT]       
                figure
                  img(src="@/assets/curso/temas/t3/t3_16.svg", alt="alt")
            .row
              .col-12         
                h5 #[em PATCH]       
                figure
